...
@EnableJpaRepositories(basePackages = {
		"com.java.study.repository" }, repositoryImplementationPostfix = "Impl", entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager")
...
public class SpringDataJpaConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource,
		...
		// 设置扫描基本包
		emfb.setPackagesToScan("com.java.study.bean");
		return emfb;
	}
