 ...
 * @author bob
 */
public class Job4 implements IJob<String, String>, ICallback<String, String> {
    ...
    public String action(String object, Map<String, JobWrapper> allJobWrappers) {
        ...
        return "result = " + CurrentTimeUtil.currentTimeMillis() + "---param = " + object + " from 4";
    }
    ...
    public void result(boolean success, String param, JobResult<String> jobResult) {
        if (success) {
            System.out.println("callback job4 success--" + CurrentTimeUtil.currentTimeMillis() + "----" + jobResult.getResult()
                    + "-threadName:" +Thread.currentThread().getName());
        } else {
            System.err.println("callback job4 failure--" + CurrentTimeUtil.currentTimeMillis() + "----"  + jobResult.getResult()
                    + "-threadName:" +Thread.currentThread().getName());
        }
    }
